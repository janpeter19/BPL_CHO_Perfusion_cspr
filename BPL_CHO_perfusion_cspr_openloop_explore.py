...
#------------------------------------------------------------------------------------------------------------------
# 2026-08-27 - Created
# 2026-09-23 - Brought numpy back here since used in several notebooks
# 2026-09-23 - Change indentaiton from 3 spaces to 4 using black
#------------------------------------------------------------------------------------------------------------------
...
def newplot(title='Perfusion cultivation',  plotType='TimeSeries'):
   ...
   if plotType == 'TimeSeries':
      ...
      diagrams.append("ax[6].plot(t,sim_res['bioreactor.culture.q[1]'], color='b', \
                       linestyle=linetype)")
      diagrams.append("ax[7].plot(t,sim_res['bioreactor.culture.q[2]'], color='r', \
                       linestyle=linetype)")
      diagrams.append("ax[8].plot(t,sim_res['harvesttank.inlet.F']*sim_res['harvesttank.inlet.c[1]'], \
                       color='b', linestyle=linetype)")
      diagrams.append("ax[9].plot(t,sim_res['bioreactor.V'], color='b', \
                       linestyle=linetype)")
      diagrams.append("ax[10].step(t,sim_res['bioreactor.inlet[1].F'], color='b', where='post', \
                       linestyle=linetype)")
   ...
   if plotType == 'Extended':
      ...
      diagrams.append("ax[2].plot(t,sim_res['bioreactor.c[5]'], color='b', linestyle=linetype)")
      diagrams.append("ax[3].plot(t,sim_res['bioreactor.c[7]'], color='r', linestyle=linetype)")
      diagrams.append("ax[4].plot(t,sim_res['bioreactor.culture.Ind_qG_over'], color='g', \
                       linestyle=linetype)")       
      diagrams.append("ax[5].plot(t,sim_res['bioreactor.culture.Ind_qGn_over'], color='g', \
                       linestyle=linetype)")    
      ...
      diagrams.append("ax[8].plot(t,sim_res['bioreactor.culture.q[1]'], color='b', \
                       linestyle=linetype)")       
      diagrams.append("ax[9].plot(t,sim_res['bioreactor.culture.q[2]'], color='r', \
                       linestyle=linetype)")  
      diagrams.append("ax[10].plot(t,sim_res['harvesttank.inlet.F']*sim_res['harvesttank.inlet.c[1]'], \
                       color='b', linestyle=linetype)")       
...
def describe(name, decimals=3):
   ...
   if name == 'culture':
      ...
      Xv  = model.get('liquidphase.Xv')[0]; Xv_description = model.get_variable_description('liquidphase.Xv');
      Xv_mw = model.get('liquidphase.mw[1]')[0]
      Xd = model.get('liquidphase.Xd')[0]; Xd_description = model.get_variable_description('liquidphase.Xd'); 
      Xd_mw = model.get('liquidphase.mw[2]')[0]
      Xl = model.get('liquidphase.Xl')[0]; Xl_description = model.get_variable_description('liquidphase.Xl'); 
      Xl_mw = model.get('liquidphase.mw[2]')[0]

      G = model.get('liquidphase.G')[0]; G_description = model.get_variable_description('liquidphase.G'); 
      G_mw = model.get('liquidphase.mw[3]')[0]
      Gn = model.get('liquidphase.Gn')[0]; Gn_description = model.get_variable_description('liquidphase.Gn'); 
      Gn_mw = model.get('liquidphase.mw[4]')[0]
      L = model.get('liquidphase.L')[0]; L_description = model.get_variable_description('liquidphase.L'); 
      L_mw = model.get('liquidphase.mw[5]')[0]
      N = model.get('liquidphase.N')[0]; N_description = model.get_variable_description('liquidphase.N'); 
      N_mw = model.get('liquidphase.mw[6]')[0]
      Pr = model.get('liquidphase.Pr')[0]; Pr_description = model.get_variable_description('liquidphase.Pr'); 
