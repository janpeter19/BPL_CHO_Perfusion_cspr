...
def newplot(title="Perfusion cultivation", plotType="TimeSeries"):
    ...
    if plotType == "TimeSeries":
        ...
        diagrams.append("ax[7].plot(t,sim_res['bioreactor.culture.q[2]'], color='r', \
                       linestyle=linetype)")
        diagrams.append(
            "ax[8].plot(t,sim_res['harvesttank.inlet.F']*sim_res['harvesttank.inlet.c[1]'], \
                       color='b', linestyle=linetype)"
        )
        diagrams.append("ax[9].plot(t,sim_res['bioreactor.V'], color='b', \
                       linestyle=linetype)")
        diagrams.append(
            "ax[10].step(t,sim_res['bioreactor.inlet[1].F'], color='b', where='post', \
                       linestyle=linetype)"
        )
        diagrams.append(
    ...
    if plotType == "Extended":
        ...
        diagrams.append(
            "ax[4].plot(t,sim_res['bioreactor.culture.Ind_qG_over'], color='g', \
                       linestyle=linetype)"
        )
        diagrams.append(
            "ax[5].plot(t,sim_res['bioreactor.culture.Ind_qGn_over'], color='g', \
                       linestyle=linetype)"
        )
        diagrams.append(
        ...
        diagrams.append("ax[9].plot(t,sim_res['bioreactor.culture.q[2]'], color='r', \
                       linestyle=linetype)")
        diagrams.append(
            "ax[10].plot(t,sim_res['harvesttank.inlet.F']*sim_res['harvesttank.inlet.c[1]'], \
                       color='b', linestyle=linetype)"
        )
        diagrams.append(
